...
const splideTitle = splide.querySelector("h2");
const splideList = splide.querySelector(".splide__list");
const signin = document.querySelector('.modalSign');
...
const userLocation = async (numerodeteluser) =>{
    ...
    const locationObj = await location.json();
    console.log(locationObj.longitude +", "+ locationObj.latitude);
    return `latlon=${locationObj.latitude}%2C${locationObj.longitude}&page=1&page_size=10`;
}
